  ...
  <div id="wrapper">
    ...
    >
      ...
      >
        ...
        <div className="sidebar-brand-text mx-3"> Invest Club </div>
      </a>
      {/* Divider */}
          ...
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-5">
              ...
              <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>Enter your password: <br /><input type="password" id="passwordShowPV" class="form-control" /> <br />
                                        <div  onClick={ShowPrivateKey} id="btnShowPrivateKey" class="btn btn-success">Show private key</div>
                                    </p>
              ...
              <div className="card shadow mb-4">
                ...
                <div className="card-body">
                  <p>
                  Invest Club is a light web wallet and Investment Club
